...
def ResultBMI(result):
    if result > 30 :
        labelResult1.configure(text = "อ้วนมาก (30.0 ขึ้นไป)")
    elif result >= 25 and result < 30 :
        labelResult1.configure(text = "อ้วน (25.0 - 29.9)")
    elif result >= 23 and result < 25 :
        labelResult1.configure(text = "น้ำหนักเกิน (23.0 - 24.9)")
    elif result >= 18.6 and result < 23 :
        labelResult1.configure(text = "น้ำหนักปกติ เหมาะสม (18.6 - 22.9)")
    else:
        labelResult1.configure(text = "ผอมเกินไป (น้อยกว่า 18.5)")
